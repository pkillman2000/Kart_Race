...
public class CameraController : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject _masterCarCamera;
    private GameObject _podiumCamera;
    ...
    private void Awake()
    {
        ...
        _podiumCamera = GameObject.FindWithTag("Podium Camera");
        if (_podiumCamera == null)
        {
            Debug.LogError("Podium Camera not found in the scene!");
        }
    ...
    public void SwitchToPodiumCamera()
    {
        DisableAllCameras();
        _masterCarCamera.SetActive(false);
        _podiumCamera.SetActive(true);
    }
}
